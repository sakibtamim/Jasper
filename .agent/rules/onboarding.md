...
Welcome, Agent. To become "Ratatarati Productive", digest the following rules:
...
## 3. Directives
- Always check `docs/specs/admin-panel/` for latest architectural decisions.
- Use `find_by_name` to locate files in this Monorepo (do not guess).
