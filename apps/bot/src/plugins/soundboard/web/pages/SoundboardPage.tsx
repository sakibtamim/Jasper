...
import { Trash2, Upload, Music, Play, AlertTriangle, Edit2, Plus, X, Volume2 } from 'lucide-react';
        ...
        <div className="p-6 w-full mx-auto">
            ...
            {isAdding && (
                <div className="mb-8 animate-in fade-in slide-in-from-top-4 duration-200">
                    <Card className={`p-6 border-2 ${editingSound ? 'border-amber-500/50' : 'border-blue-500/50'}`}>
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <button onClick={handleCancelForm} className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200">
                                <X className="w-5 h-5" />
                            </button>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <Input
                                    ...
                                    required
                                />
                                <p className="text-xs text-gray-500 mt-1">Supports standard emojis and custom Discord emojis.</p>
                            </div>
            ...
            {sounds.length === 0 ? (
                <div className="text-center py-12 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-dashed border-gray-300 dark:border-gray-700">
                    ...
                    <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-1">No sounds yet</h3>
                    <p className="text-gray-500 mb-4">Upload your first sound effect to get started.</p>
                    <Button onClick={() => setIsAdding(true)}>
                        <Plus className="w-4 h-4 mr-2" />
                        Add Sound
                    </Button>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-3">
                    {sounds.map(sound => (
                        <Card key={sound.id} className="group relative p-3 flex flex-col items-center text-center hover:shadow-md transition-all duration-200 border-gray-200 dark:border-gray-800 hover:border-blue-300 dark:hover:border-blue-700">
                            ...
                            <h3 className="text-sm font-medium text-gray-900 dark:text-white w-full truncate px-1" title={sound.name}>
                                {sound.name}
                            </h3>
