            ...
            <footer className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 py-12 mt-auto">
                <div className="container mx-auto px-4 space-y-8">
                    ...
                    <div className="flex justify-center gap-6 flex-wrap">
                        <a
                            href="https://sakibtamim.github.io/Jasper/"
                            className="flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-brand-primary dark:hover:text-brand-primary transition-colors group"
                            target="_blank"
                    ...
                    <div className="text-center space-y-3 border-t border-gray-200 dark:border-gray-700 pt-6">
                        <p className="text-xs text-gray-600 dark:text-gray-400">
                            <span className="font-semibold">Built by</span> Nazmus Sakib Tamim &
