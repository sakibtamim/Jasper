...
export default function DevToolsPage() {
  ...
  const handleFileUpload = async (
    ...
    try {
      ...
      setMessage(
        `Success: ${data.message}. Please restart the bot to apply changes.`,
      );
  ...
  const regenerateThumbnail = async (videoId: string) => {
    if (
      !confirm("Regenerate thumbnail? This will fetch metadata from YouTube.")
    )
      return;
    try {
        ...
        {PROTECTED_TABS.includes(activeTab) && !isAuthenticated ? (
          <div className="flex flex-col items-center justify-center h-64 text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400 max-w-md mb-6">
              This tab contains sensitive information or actions. Please log in
              to access it.
            </p>
            <a
              href="/api/auth/login"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                      ...
                      <div className="text-2xl font-bold text-gray-900 dark:text-white">
                        ...
                        {Math.floor(((data.totalDuration || 0) % 3600) / 60)}m
                      </div>
                    </div>
                    <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                      <div className="text-sm text-gray-500 dark:text-gray-400">
                        ...
                        {data.users.map((user: any) => (
                          ...
                          >
                            ...
                            <td className="px-6 py-4">
                              <button
                                onClick={() =>
                                  deleteItem(`/api/devtools/users/${user.id}`)
                                }
                            ...
                            {data.audio?.map((entry: any) => (
                              ...
                              >
                                ...
                                <td className="px-6 py-4 flex gap-2">
                                  <button
                                    onClick={() =>
                                      regenerateThumbnail(entry.videoId)
                                    }
