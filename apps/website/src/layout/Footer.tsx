    ...
    return (
        <footer className="py-12 px-6 border-t border-slate-800 text-center bg-[#0f172a]">
            ...
            <div className="max-w-2xl mx-auto space-y-4">
                <p className="text-slate-300 font-medium">Built by Purrfect Software Limited</p>
                <p className="text-slate-500 text-xs leading-relaxed">
                    Powered by humans, cats, and an AI swarm (Gemini for scaffolding, Antigravity
                    Agent 47/69 for integration, and language models for planning and docs).
                </p>
