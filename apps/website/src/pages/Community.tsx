    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <Section className="relative">
        ...
        <div className="max-w-3xl mx-auto mb-12 text-center text-slate-300">
          <p className="text-lg">
            Jasper lives best when it’s part of a community. Whether you’re a
            server admin, a developer, or just someone who loves music bots,
            you’re welcome here.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="bg-slate-800/50 border border-slate-700 p-8 rounded-xl hover:bg-slate-800 transition-all hover:-translate-y-1 text-center group">
            ...
            <ul className="text-slate-400 space-y-3 mb-8 text-left max-w-xs mx-auto">
              <li className="flex items-center gap-3">
                <Star size={16} className="text-yellow-400" /> Star the GitHub
                repo
              </li>
              <li className="flex items-center gap-3">
                <GitPullRequest size={16} className="text-green-400" /> Open
                issues & PRs
              </li>
              <li className="flex items-center gap-3">
                <MessageCircle size={16} className="text-blue-400" /> Share
                plugin ideas
              </li>
            </ul>
            <a
          ...
          <div className="bg-slate-800/50 border border-slate-700 p-8 rounded-xl hover:bg-slate-800 transition-all hover:-translate-y-1 text-center group">
            ...
            <p className="text-slate-400 mb-8 leading-relaxed">
              Check the <code>CONTRIBUTING.md</code> (if present) or open a PR
              with small, focused changes. Even doc fixes are valuable.
            </p>
            <a
