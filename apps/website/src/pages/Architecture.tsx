...
import { Server, Database, Zap, Layers, Command, Globe } from 'lucide-react';
                ...
                <div className="max-w-4xl mx-auto space-y-12">
                    <div className="bg-slate-800/30 p-8 rounded-xl border border-slate-700 backdrop-blur-sm">
                        <p className="text-lg text-slate-300 leading-relaxed">
                            Jasper is designed to be understandable, debuggable, and extendable. This page gives you a high-level view of how the pieces fit together.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                            {[
                                { icon: Command, label: "Jasper Core", desc: "Discord client, command handling, and lifecycle management." },
                                { icon: Layers, label: "Plugin Manager", desc: "Discovers and loads plugins from src/plugins." },
                                { icon: Zap, label: "Hook System", desc: "Allows plugins to tap into events without modifying the core." },
                                { icon: Server, label: "Workers", desc: "Handle music playback and other long-running tasks." },
                                { icon: Globe, label: "Web Dashboard", desc: "A simple UI for inspecting queues, stats, and configuration." },
                                { icon: Database, label: "Database Layer", desc: "Adapters for SQLite and PostgreSQL, sitting behind a clean abstraction." },
                            ].map((item, i) => (
                                <div key={i} className="flex gap-4 p-4 bg-slate-800/50 rounded-lg border border-slate-700 hover:border-[#00e5ff]/50 transition-colors">
