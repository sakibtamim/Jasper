        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <Section className="relative">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-slate-400 max-w-2xl mx-auto">Build on Jasper</p>
                </div>

                <div className="max-w-4xl mx-auto space-y-12">
                    <div className="bg-slate-800/30 p-8 rounded-xl border border-slate-700 backdrop-blur-sm">
                        <p className="text-lg text-slate-300 leading-relaxed">
                            Jasper is not just a bot; it’s a small framework for building Discord
                            bot plugins. If you’re comfortable with TypeScript/JavaScript and
                            Node.js, you can ship your first plugin in an evening.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6 space-y-4 relative overflow-hidden">
                            ...
                            <ol className="list-decimal list-inside space-y-4 text-slate-300 relative z-10">
                                ...
                                <li className="pl-2">
                                    Restart Jasper — the plugin should be discovered automatically.
                                </li>
                            </ol>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="bg-slate-800/30 p-6 rounded-xl border border-slate-700">
                                ...
                                <p className="text-slate-400 text-sm">
                                    To keep the core stable and safe, while letting experimentation
                                    happen at the edges.
                                </p>
                            </div>
                            <div className="bg-slate-800/30 p-6 rounded-xl border border-slate-700">
