      ...
      <Section className="relative">
        ...
        <div className="max-w-3xl mx-auto mb-16 text-slate-300 leading-relaxed bg-slate-800/30 p-8 rounded-xl border border-slate-700 backdrop-blur-sm text-center">
          ...
          <p className="mb-4 text-lg">
            Jasper is a project by Purrfect Software Limited, part of the wider
            Purrfect Universe. It sits at the intersection of engineering,
            playfulness, and AI-assisted development.
          </p>
          <p>
            The goal is simple: build tools that feel good to use, are honest
            about how they’re made, and stay friendly to contributors.
          </p>
        </div>

        <div className="grid md:grid-cols-2 gap-8">
          <Card title="Plugin-First" icon={Terminal} color="primary">
            Keep the core small and stable, let plugins carry experiments and
            features.
          </Card>

          <Card title="Transparent Architecture" icon={Cpu} color="secondary">
            No black boxes. If something breaks, it should be debuggable by a
            reasonably curious engineer.
          </Card>

          <Card title="AI as a Colleague" icon={Smile} color="secondary">
            Jasper is actively shaped by AI agents (for scaffolding,
            refactoring, docs) with human oversight.
          </Card>

          <Card title="Fun Is a Feature" icon={Heart} color="primary">
            We believe tools can be serious and still have personality. The
            Heavenly Council of Fur insists on it.
          </Card>
        </div>
      </Section>
    </div>
