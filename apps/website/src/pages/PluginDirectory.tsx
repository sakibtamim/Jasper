    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <Section className="relative">
        ...
        <div className="max-w-3xl mx-auto mb-16 text-slate-300 leading-relaxed bg-slate-800/30 p-8 rounded-xl border border-slate-700 backdrop-blur-sm">
          ...
          <p>
            Below is a showcase of first-party plugins. In the future, this page
            can list community plugins discovered from the repository.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <Card title="Statistics" icon={BarChart2} color="secondary">
            <p className="mb-4">
              Tracks what’s being played, by whom, and how often. Powers
              dashboards and <code>/api/stats</code>.
            </p>
            <div className="flex gap-2">
              <span className="px-2 py-1 bg-slate-800 rounded text-xs text-slate-400 border border-slate-700">
                metrics
          ...
          <Card title="Soundboard (WIP)" icon={Mic} color="secondary">
            <p className="mb-4">
              Discord-style soundboard powered by Jasper’s worker architecture.
              More sounds, more chaos, less compromise.
            </p>
            <div className="flex gap-2">
              <span className="px-2 py-1 bg-slate-800 rounded text-xs text-slate-400 border border-slate-700">
                fun
          ...
          <Card title="Fun & Utility Commands" icon={Command} color="primary">
            <p className="mb-4">
              Lightweight commands for memes, diagnostics, and server
              quality-of-life.
            </p>
            <div className="flex gap-2">
              <span className="px-2 py-1 bg-slate-800 rounded text-xs text-slate-400 border border-slate-700">
