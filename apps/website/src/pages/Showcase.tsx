    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <Section className="relative">
        ...
        <div className="max-w-3xl mx-auto mb-16 text-slate-300 leading-relaxed text-center bg-slate-800/30 p-6 rounded-xl border border-slate-700 backdrop-blur-sm">
          <p>
            A few examples of what Jasper can do today. In the future, this page
            can host real screenshots, GIFs, or short clips.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Card title="Soundboard (coming soon)" icon={Mic} color="primary">
            <p className="text-sm text-slate-300 mb-4">
              A custom soundboard experience where Jasper handles voice
              connections, playback, and chaos.
            </p>
        ...
        <div className="mt-16 text-center p-8 border border-dashed border-slate-700 rounded-xl text-slate-500 bg-slate-900/20">
          <p>
            This page is intentionally simple for now. Once visual assets are
            ready, they can be dropped in as cards or embeds.
          </p>
        </div>
      </Section>
    </div>
