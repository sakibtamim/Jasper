...
import { Cat, Cpu, Layers, Music, Server, ShieldAlert, Terminal, Zap } from 'lucide-react';
            ...
            <section className="relative pt-32 pb-20 px-6 min-h-[90vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto text-center relative z-10">
                    ...
                    <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-8 leading-relaxed">
                        Plugin-driven. AI-assisted. Built for busy communities that want great vibes
                        without complexity.
                    </p>
                    ...
                    <div className="text-slate-400 max-w-3xl mx-auto mb-16 leading-relaxed bg-slate-900/50 p-6 rounded-xl border border-slate-800">
                        <p className="mb-4">
                            Jasper is a modern Discord bot built with care by Purrfect Software
                            Limited. It focuses on high-quality music playback, extensible plugins,
                            and a clean architecture that’s friendly to both server owners and
                            developers.
                        </p>
                        <p>
                            Under the hood, Jasper is powered by a swarm of humans, AI agents, and
                            the ever-watchful Heavenly Council of Fur 🐾.
                        </p>
                    </div>
                        ...
                        {activeTab === 'cat' ? (
                            ...
                            <div className="text-left w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
                                ...
                                <p className="text-slate-300 mb-6">
                                    ...
                                    <strong>Resource Pool</strong> pattern. The Controller receives
                                    commands and schedules work onto available Worker Tokens.
                                </p>
            ...
            <Section className="bg-slate-900/30 border-y border-slate-800" id="features">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <Card title="Built-In Statistics" icon={Zap} color="primary">
                        Track top songs, active listeners, and global usage with a dedicated stats
                        API.
                    </Card>

                    <Card title="AI-Assisted" icon={Cpu} color="secondary">
                        Jasper’s codebase is actively shaped by AI agents (planning, refactoring,
                        docs) with human review.
                    </Card>
                </div>
            </Section>
            ...
            <Section id="principles">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <Card title="Outsource the Fragile" icon={ShieldAlert} color="secondary">
                        YouTube changes constantly. We don't reverse-engineer it. We delegate
                        extraction to{' '}
                        <code className="text-[#00e5ff] bg-slate-900 px-1 rounded">yt-dlp</code>{' '}
                        running as a child process. When YouTube breaks, you update the binary, not
                        the bot.
                    </Card>

                    <Card title="Automatic Feline Rotation" icon={Layers} color="primary">
                        AFR isn't just cute flavor text; it's a policy engine. It creates a weighted
                        choice between the Controller and dedicated Workers, treating Discord
                        playback as a scheduling problem.
                    </Card>
                    ...
                    <Card title="Operational Reality" icon={Terminal} color="secondary">
                        ...
                        to nuke queues from orbit when state gets corrupted, without SSH-ing into
                        the box.
                    </Card>
                </div>
            </Section>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <p className="text-slate-400 text-lg mb-8 leading-relaxed">
                            Jasper separates concerns strictly. The <strong>Bot</strong> owns the
                            Discord connection. The <strong>Web App</strong> owns the dashboard.
                            Shared packages keep types in sync.
                        </p>
