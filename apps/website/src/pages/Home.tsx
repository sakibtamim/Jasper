...
export const Home = () => {
  ...
  return (
    <>
      ...
      <section className="relative pt-32 pb-20 px-6 min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-8 leading-relaxed">
            Plugin-driven. AI-assisted. Built for busy communities that want
            great vibes without complexity.
          </p>
          ...
          <div className="text-slate-400 max-w-3xl mx-auto mb-16 leading-relaxed bg-slate-900/50 p-6 rounded-xl border border-slate-800">
            <p className="mb-4">
              Jasper is a modern Discord bot built with care by Purrfect
              Software Limited. It focuses on high-quality music playback,
              extensible plugins, and a clean architecture that’s friendly to
              both server owners and developers.
            </p>
            <p>
              Under the hood, Jasper is powered by a swarm of humans, AI agents,
              and the ever-watchful Heavenly Council of Fur 🐾.
            </p>
          </div>
            ...
            {activeTab === "cat" ? (
              <div className="text-left w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
                <h3 className="text-2xl font-bold text-[#ff6ad5] mb-4 flex items-center gap-2">
                  <Music className="animate-bounce" /> The Heavenly Council of
                  Fur
                </h3>
                <p className="text-slate-300 mb-6">
                  Jasper isn't just one bot. It's a council. When you request a
                  song, Jasper might play it, or he might dispatch one of his
                  feline workers based on load and availability.
                </p>
                <div className="space-y-3">
                  <WorkerCat
                    name="Jasper (Controller)"
                    role="The Boss & Scheduler"
                    status="Online"
                    delay={0}
                  />
                  <WorkerCat
              ...
              <div className="text-left w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <p className="text-slate-300 mb-6">
                  Traditional bots use one token. Jasper uses a{" "}
                  <strong>Resource Pool</strong> pattern. The Controller
                  receives commands and schedules work onto available Worker
                  Tokens.
                </p>
                <div className="font-mono text-xs md:text-sm bg-black/50 p-4 rounded-lg border border-slate-700 text-slate-300">
                  ...
                  <div className="grid grid-cols-3 gap-2 text-center">
                    <div className="bg-slate-800 p-2 rounded text-slate-500">
                      Worker 1 (Busy)
                    </div>
                    <div className="bg-[#00e5ff]/20 text-[#00e5ff] border border-[#00e5ff]/50 p-2 rounded">
                      Worker 2 (Selected)
                    </div>
      ...
      {/* Key Features */}
      <Section
        className="bg-slate-900/30 border-y border-slate-800"
        id="features"
      >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card title="Plugin-First Design" icon={Layers} color="secondary">
            Extend Jasper without touching the core. Drop plugins into{" "}
            <code>src/plugins</code> and go.
          </Card>

          <Card title="Built-In Statistics" icon={Zap} color="primary">
            Track top songs, active listeners, and global usage with a dedicated
            stats API.
          </Card>

          <Card title="AI-Assisted" icon={Cpu} color="secondary">
            Jasper’s codebase is actively shaped by AI agents (planning,
            refactoring, docs) with human review.
          </Card>
        </div>
      </Section>
      ...
      <Section id="principles">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">
            Jasper is built on the philosophy that "works on my machine" isn't
            enough. It's designed for resilience, scalability, and developer
            sanity.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card
            title="Outsource the Fragile"
            icon={ShieldAlert}
            color="secondary"
          >
            YouTube changes constantly. We don't reverse-engineer it. We
            delegate extraction to{" "}
            <code className="text-[#00e5ff] bg-slate-900 px-1 rounded">
              yt-dlp
            </code>{" "}
            running as a child process. When YouTube breaks, you update the
            binary, not the bot.
          </Card>

          <Card title="Automatic Feline Rotation" icon={Layers} color="primary">
            AFR isn't just cute flavor text; it's a policy engine. It creates a
            weighted choice between the Controller and dedicated Workers,
          ...
          <Card title="Operational Reality" icon={Terminal} color="secondary">
            ...
            <code className="text-red-400 bg-slate-900 px-1 mx-1 rounded">
              /catastrophic-reset
            </code>
            to nuke queues from orbit when state gets corrupted, without SSH-ing
            into the box.
          </Card>
        </div>
      </Section>
      ...
      <Section
        className="bg-slate-900/30 border-t border-slate-800"
        id="architecture"
      >
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-slate-400 text-lg mb-8 leading-relaxed">
              Jasper separates concerns strictly. The <strong>Bot</strong> owns
              the Discord connection. The <strong>Web App</strong> owns the
              dashboard. Shared packages keep types in sync.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm mt-1">
                    Starts with SQLite (zero-config). Scales to PostgreSQL when
                    you need concurrency. The codebase abstracts DB access so
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm mt-1">
                    Saves 90-95% bandwidth on repeated songs. Includes explicit
                    TTL tuning and cleanup intervals to balance disk usage vs
                    speed.
                  </p>
                </div>
              </div>
            ...
            <div className="relative bg-[#0f172a] border border-slate-700 rounded-xl overflow-hidden shadow-2xl">
              <div className="bg-[#1e293b] px-4 py-3 border-b border-slate-700 flex items-center gap-2">
                ...
                <span className="ml-2 text-xs font-mono text-slate-400">
                  jasper-bot — -zsh — 80x24
                </span>
              </div>
              <div className="p-6 font-mono text-sm text-slate-300">
                <div className="mb-4">
                  <span className="text-green-400">➜</span>{" "}
                  <span className="text-blue-400">~</span> jasper music-status
                </div>
                <div className="space-y-1 text-xs md:text-sm">
                  <div className="text-slate-400">
                    Please wait, querying worker pool...
                  </div>
                  <div className="grid grid-cols-2 gap-4 mt-2">
                    <div>
                      ...
                      Guilds: 14
                      <br />
                      Voice: <span className="text-yellow-400">Idle</span>
                      <br />
                      Ping: 24ms
                    </div>
                    <div>
                      ...
                      Guild: "Dev Server"
                      <br />
                      Voice: <span className="text-green-400">Playing</span>
                      <br />
                      Track: "Lo-Fi Beats..."
                    </div>
                  </div>
      ...
      <Section className="bg-slate-900/50 border-t border-slate-800" id="docs">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-400">
            Essential guides and common troubleshooting steps.
          </p>
        </div>
        <DocTabs />
      </Section>
