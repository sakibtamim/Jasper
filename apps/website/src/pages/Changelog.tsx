            ...
            <Section className="relative">
                ...
                <div className="max-w-3xl mx-auto space-y-12">
                    <div className="text-slate-300 mb-8 text-center bg-slate-800/30 p-6 rounded-xl border border-slate-700 backdrop-blur-sm">
                        <p>Jasper is under active development. This page summarizes notable changes over time.</p>
                    </div>
                    ...
                    <div className="relative border-l-2 border-slate-800 pl-8 space-y-16 ml-4 md:ml-0">
                        ...
                        <div className="relative group">
                            ...
                            <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 mb-4">
                                <h3 className="text-2xl font-bold text-white group-hover:text-[#ff6ad5] transition-colors">v0.3.0 — Plugin System & Stats</h3>
                            ...
                            <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700 hover:border-[#ff6ad5]/30 transition-colors">
                                <ul className="space-y-3">
                                    <li className="flex gap-3 text-slate-300">
                                        <GitCommit className="text-[#ff6ad5] mt-1 shrink-0" size={18} />
                                        <span>Introduced the plugin manager and hook system.</span>
                                    </li>
                                    <li className="flex gap-3 text-slate-300">
                                        <GitCommit className="text-[#ff6ad5] mt-1 shrink-0" size={18} />
                                        <span>Added the Statistics plugin and <code>/api/stats</code>.</span>
                                    </li>
                                    <li className="flex gap-3 text-slate-300">
                                        <GitCommit className="text-[#ff6ad5] mt-1 shrink-0" size={18} />
                                        <span>Improved database abstraction with SQLite and Postgres support.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="relative group">
                            ...
                            <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 mb-4">
                                <h3 className="text-2xl font-bold text-white group-hover:text-[#00e5ff] transition-colors">v0.2.0 — Web Dashboard</h3>
                                <span className="inline-flex items-center gap-1 px-2 py-1 rounded bg-slate-800 text-xs text-slate-400 border border-slate-700">
                            ...
                            <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700 hover:border-[#00e5ff]/30 transition-colors">
                                <ul className="space-y-3">
                                    <li className="flex gap-3 text-slate-300">
                                        <GitCommit className="text-[#00e5ff] mt-1 shrink-0" size={18} />
                                        <span>Added a basic web dashboard to inspect queues and stats.</span>
                                    </li>
                                    <li className="flex gap-3 text-slate-300">
                                        <GitCommit className="text-[#00e5ff] mt-1 shrink-0" size={18} />
                                        <span>Integrated Fastify routes for serving dashboard data.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="relative group">
                            ...
                            <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 mb-4">
                                <h3 className="text-2xl font-bold text-white group-hover:text-slate-400 transition-colors">v0.1.0 — First Public Release</h3>
                                <span className="inline-flex items-center gap-1 px-2 py-1 rounded bg-slate-800 text-xs text-slate-400 border border-slate-700">
                            ...
                            <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700 hover:border-slate-600 transition-colors">
                                <ul className="space-y-3">
                                    <li className="flex gap-3 text-slate-300">
                                        <GitCommit className="text-slate-500 mt-1 shrink-0" size={18} />
