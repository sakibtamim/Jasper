...
> **Context**: This guide focuses on the _workflow_ of developing plugins for Jasper, specifically covering strict architectural patterns, out-of-tree development, and git strategies.
...
3.  **Link**:
    ...
    ```
    _This creates a symlink in `apps/bot/src/plugins/<id>`._
